...
class BalanceCar:
    ...
    def update(self, motor_force, dt=0.1):
        # 简化的平衡车动力学模型
...
def main():
    ...
    angle_pid = PIDController(kp=80, ki=10, kd=30, setpoint=0)  # 角度控制PID
    speed_pid = PIDController(kp=2, ki=0.1, kd=0.0, setpoint=0)  # 速度控制PID
